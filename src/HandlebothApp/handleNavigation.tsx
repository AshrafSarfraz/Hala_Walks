// App.tsx (AppStack / handleNavigation)
...
const AppStack = () => {
  ...
  // ✅ onReady — NavigationContainer mount hone ke baad call hoga
  // Killed mode mein notification press karne ke baad app yahan se navigate karega
  const handleNavigationReady = () => {
    checkAndNavigatePendingVenue();
  };
