...
import { Contact_us, DocIcon, HistroyIcon, P_IMG, ProfileIcon } from '../../../theme/Images';
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.Bg }}>
      ...
      <View style={styles.Button_Cont}>
        <CustomButton2
          ...
          image={ProfileIcon}
          onPress={() => {
            navigation.navigate('TenantsProfile');
          }}
        />
        <CustomButton2
          ...
          image={DocIcon}
          onPress={() => {
            navigation.navigate('TenantDocumentControlScreen');
          }}
        />
        <CustomButton2
          ...
          image={HistroyIcon}
          onPress={() => {
            navigation.navigate('TenantsHistroyScreen');
          }}
        />
        <CustomButton2
