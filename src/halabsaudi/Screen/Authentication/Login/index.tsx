...
import { Hbk_White, HBS_Logo } from '../../../Themes/Images';
...
const Login: React.FC<NativeStackScreenProps<any>> = ({ navigation }) => {
  useStatusBar('light-content', Colors.Bg, );
    ...
    <ScrollView contentContainerStyle={styles.MainContainer}>
      ...
      <View style={styles.InputContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('SignUp')} style={{ alignSelf: 'center', marginTop: 20 }}>
          <Text style={{ color: Colors.White, fontWeight: '600', textDecorationLine: 'underline' }}>
