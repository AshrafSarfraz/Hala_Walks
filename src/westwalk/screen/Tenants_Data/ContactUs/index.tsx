...
const API_URL = 'https://hala-b-saudi.onrender.com/api/westwalk/maintainceRequest';
...
const WebViewScreen = ({ navigation }: any) => {
    ...
    const validate = () => {
        const required = ['name', 'unitno', 'buildingno', 'phoneNumber', 'email', 'subject', 'description'];
                ...
                Alert.alert('✅ Submitted', 'Your maintenance request has been submitted successfully.', [
                    {
                        text: 'OK',
                        onPress: () => {
                            setForm({ name: '', unitno: '', buildingno: '', phoneNumber: '', email: '', subject: '', description: '' });
                            setImages([]);
                        },
                    },
                ]);
        ...
        >
            ...
            >
                ...
                <View style={styles.section}>
                    ...
                    <Field label="Full Name" placeholder="e.g. Ashraf M Sarfraz" value={form.name} onChangeText={v => handleChange('name', v)} />
                    <Field label="Email Address" placeholder="e.g. ashraf@email.com" value={form.email} onChangeText={v => handleChange('email', v)} keyboardType="email-address" />
                    <Field label="Phone Number" placeholder="e.g. +966 5X XXX XXXX" value={form.phoneNumber} onChangeText={v => handleChange('phoneNumber', v)} keyboardType="phone-pad" />
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Field label="Subject" placeholder="e.g. AC not working" value={form.subject} onChangeText={v => handleChange('subject', v)} />
                ...
                <View style={styles.section}>
                    <View style={styles.imageSectionHeader}>
                        <Text style={styles.sectionTitle}>
                            Attach Images <Text style={styles.optional}>(Optional · max 3)</Text>
                        </Text>
...
const Field: React.FC<FieldProps> = ({ label, placeholder, value, onChangeText, keyboardType = 'default' }) => (
    <View style={styles.fieldWrapper}>
...
const styles = StyleSheet.create({
    ...
    headerSubtitle: { fontSize: 13, color: '#9ca3af', textAlign: 'center', lineHeight: 20 },
    ...
    submitBtnText: { color: '#fff', fontSize: 16, fontWeight: '700', letterSpacing: 0.4 },
