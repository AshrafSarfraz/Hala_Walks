...
const images = [
  { id: '1', text: 'Food and Drink', category: 'Food & Drink', categoryArabic: 'المأكولات والمشروبات', source: require('../../../../assets/images/food_drinks.jpg') },
  { id: '2', text: 'Retail and Services ', category: 'Retail & Services', categoryArabic:  'التجزئة والخدمات' , source: require('../../../../assets/images/shop.png') },
  { id: '3', text: 'Beauty and Spa', category: 'Beauty spa & Fitness',categoryArabic: 'منتجع تجميل ولياقة بدنية'  ,source: require('../../../../assets/images/beauty_spa.jpg') },
